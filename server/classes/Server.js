...
import CustomerController from "../controllers/School_db/CustomerController";
import RegionController from "../controllers/School_db/RegionController";
import TerritoryController from "../controllers/School_db/TerritoryController";
...
class Server {
 ...
 // End Init Database
    ...
    // Start Init Controllers
		...
		RegionController.init(router);
		TerritoryController.init(router);
